...
- When an uploaded image or PDF is handled by image processing libraries or document parsers ([CVE-2016–3714](https://nvd.nist.gov/vuln/detail/CVE-2016-3714), [CVE-2024–34790](https://nvd.nist.gov/vuln/detail/CVE-2024-34790), [CVE-2025–5138](https://nvd.nist.gov/vuln/detail/CVE-2025-5138))

- When the metadata contained in a file is processed or manipulated by the server after the upload ([CVE-2021–22204](https://nvd.nist.gov/vuln/detail/CVE-2021-22204))

- When the file and, as a consequence, its extension, can be modified after it has been uploaded ([CVE-2020–36847](https://nvd.nist.gov/vuln/detail/CVE-2020-36847))
...
- **Parasites**: Injects _file 2_ into a location inside _file 1_ that allows arbitrary data without breaking its structure. This works if file1 has flexible or unused chunks.

- **Zippers**: Builds a file that is valid for both parsers simultaneously. It is created by overlapping the structures of _file 1_ and _file 2_, effectively “zipping” both formats together. The result is a more complex structure compared to parasite files.
...
<p style="text-align: center; font-style: italic; color: gray;"><em>Mitra showing that both stack and parasite polyglots were created</em></p>
<br>
...
<p style="text-align: center; font-style: italic; color: gray;"><em>Showing in a hex editor the contents of the parasite file</em></p>
<br>
...
<p style="text-align: center; font-style: italic; color: gray;"><em>A Browser executing JavaScript contained inside a PNG that was renamed to an HTML extension</em></p>
<br>

Moving on to the stack file, it simply concatenated both files.

![Cuarta imagen](/assets/img/Polyglot-Post/image4.png)
<p style="text-align: center; font-style: italic; color: gray;"><em>A hex editor showing the contents of the Stack polyglot</em></p>
<br>
...
<p style="text-align: center; font-style: italic; color: gray;"><em>Editors showing the contents of a PDF filewhere a shellscript was injected</em></p>
<br>
...
**Github**: [https://github.com/corkami/mitra](https://github.com/corkami/mitra)
...
<p style="text-align: center; font-style: italic; color: gray;"><em>A hex editor showing the contents of a PNG file, which contains a JSP payload in the metadata
</em></p>
<br>
...
- [CVE-2024–43445](https://nvd.nist.gov/vuln/detail/cve-2024-43445)

- [CVE-2023–36918](https://nvd.nist.gov/vuln/detail/cve-2023-36918)

- [CVE-2018–17031](https://nvd.nist.gov/vuln/detail/CVE-2018-17031)
